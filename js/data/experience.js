...
window.PORTFOLIO.experiences = [
  ...
  {
    org:    'MUNA',
    url:    'https://muslimummah.org/',
    role:   'Associate Member — Manhattan Youth Sub-Chapter',
    dates:  '2022 – PRESENT',
    points: [
  ...
  },
  {
    ...
    dates:  '2021 – PRESENT',
    points: [
      'Build full Roblox games, from single mechanics to complete frameworks.',
      'Develop custom, optimized Discord bots for community servers.',
      'Automate marketplace and trading-platform workflows with custom tooling.',
      'Design and ship REST APIs for client applications.',
    ],
  },
];
